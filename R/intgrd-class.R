...
#' Extract parts of the intgrd object
#' @rdname $
...
# interval slot for an existing intgrd object.
...
# This method allows a user to create an intgrd object by
# definining the interval slot. (Similar to sp::coordinates).
#' Create intgrd object
#' @rdname interval
...
#' Sumarize the contents of an intgrd object, including special summaries for
#' the interval slot.
#'
...
#' the interval slot of an intgrd object.
#'
#' @param x an object of class intgrd
...
#' Conversion from intgrd to data frame.
#'
#' This function simply converts an intgrd object to a SpatialPixelsDataFrame
#' object prior to calling as.data.frame.SpatialPixelsDataFrame.
#'
#' @param x an object of class intgrd
